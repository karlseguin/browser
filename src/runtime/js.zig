...
pub fn Env(comptime S: type, comptime types: anytype) type {
    ...
    return struct {
        ...
        pub fn startExecutor(self: *Self, comptime Global: type, state: State, module_loader: anytype) !*Executor {
            ...
            {
                // Given our execution context, we can get our executor.
        ...
        pub const Executor = struct {
            ...
            pub fn startScope(self: *Executor, global: anytype) !void {
                ...
                const context = self.context;
                _ = try self._mapZigInstanceToJs(context, context.getGlobal(), global);
            }
            ...
            fn mapZigInstanceToJs(context: v8.Context, js_obj_or_template: anytype, value: anytype) !PersistentObject {
                ...
                return executor._mapZigInstanceToJs(context, js_obj_or_template, value);
            }

            fn _mapZigInstanceToJs(self: *Executor, context: v8.Context, js_obj_or_template: anytype, value: anytype) !PersistentObject {
                ...
                switch (@typeInfo(T)) {
                    .@"struct" => {
                        ...
                        heap.* = value;
                        return self._mapZigInstanceToJs(context, js_obj_or_template, heap);
                    },
                    .pointer => |ptr| {
